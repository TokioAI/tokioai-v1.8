...
class TenantResolver:
    ...
    def __init__(self):
        ...
        self.postgres_db = os.getenv('POSTGRES_DB', 'soc_ai')
        self.postgres_user = os.getenv('POSTGRES_USER', 'soc_user')
        self.postgres_password = os.getenv("POSTGRES_PASSWORD", "YOUR_POSTGRES_PASSWORD"))
