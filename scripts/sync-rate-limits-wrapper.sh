#!/bin/bash
# Wrapper script para sync-rate-limits-to-nginx.py
...
export NGINX_RATE_LIMIT_FILE=/opt/tokio-ai-waf/modsecurity/rules/auto-rate-limits.conf
export MODSEC_RATE_LIMIT_FILE=/opt/tokio-ai-waf/modsecurity/rules/auto-rate-limits-modsec.conf
...
exec /usr/bin/python3 /opt/tokio-ai-waf/scripts/sync-rate-limits-to-nginx.py "$@"
